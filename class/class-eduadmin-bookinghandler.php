	...
	public function process_booking() {
		if ( isset( $_POST['act'] ) && 'bookCourse' === $_POST['act'] ) {
			...
			if ( $singlePersonBooking ) {
				include_once( __DIR__ . '/../content/template/bookingTemplate/__bookSingleParticipant.php' );
			} else {
				include_once( __DIR__ . '/../content/template/bookingTemplate/__bookMultipleParticipants.php' );
			}

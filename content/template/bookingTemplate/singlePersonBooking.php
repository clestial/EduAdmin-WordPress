...
<div class="contactView">
	...
	<label>
		...
		<div class="inputHolder">
			<input type="text" style="width: 48%; display: inline;"<?php echo( $__block ? " readonly" : "" ); ?>
				   required onchange="eduBookingView.ContactAsParticipant();" id="edu-contactFirstName"
				   name="contactFirstName" placeholder="<?php edu_e( "Contact first name" ); ?>"
				   value="<?php echo @esc_attr( explode( ' ', $contact->ContactName )[0] ); ?>" />
			<input type="text" style="width: 48%; display: inline;"<?php echo( $__block ? " readonly" : "" ); ?>
		...
		<label>
			<div class="inputHolder alsoInvoiceCustomer">
				<input type="checkbox" id="alsoInvoiceCustomer" name="alsoInvoiceCustomer" value="true"
					   onchange="eduBookingView.UpdateInvoiceCustomer();" />

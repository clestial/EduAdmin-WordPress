<div class="eduadmin loginForm">
	<div class="loginBox">
		...
		<form action="" method="POST" onsubmit="">
			...
			?>
			<button class="loginButton cta-btn" onclick="this.form.eduadminpassword.required = true; this.form.eduformloginaction.value = 'login';<?php echo $click; ?>"><?php esc_html_e( 'Log in', 'eduadmin-booking' ); ?></button>

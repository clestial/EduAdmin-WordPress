...
function render_check_field( $attribute, $multiple, $suffix, $data ) {
	...
	echo '<input type="checkbox"' . ( ! empty( $data ) && $data ? ' checked="checked"' : '' ) . ' placeholder="' . esc_attr( wp_strip_all_tags( $attribute['CustomFieldName'] ) ) . '" name="edu-attr_' . esc_attr( $attribute['CustomFieldId'] . '_check' . ( '' !== $suffix ? '-' . $suffix : '' ) . ( $multiple ? '[]' : '' ) ) . '" />';
	echo '</div></label>';
}
...
function render_text_field( $attribute, $multiple, $suffix, $data ) {
	...
	echo wp_kses_post( $attribute['CustomFieldName'] );
	echo '</div><div class="inputHolder">';
	echo '<input type="text" placeholder="' . esc_attr( wp_strip_all_tags( $attribute['CustomFieldName'] ) ) . '" name="edu-attr_' . esc_attr( $attribute['CustomFieldId'] . '_text' . ( '' !== $suffix ? '-' . $suffix : '' ) . ( $multiple ? '[]' : '' ) ) . '" value="' . esc_attr( ( ! empty( $data ) ? $data : '' ) ) . '" />';
	echo '</div></label>';
}
...
function render_number_field( $attribute, $multiple, $suffix, $data ) {
	...
	echo wp_kses_post( $attribute['CustomFieldName'] );
	echo '</div><div class="inputHolder">';
	echo '<input type="number" placeholder="' . esc_attr( wp_strip_all_tags( $attribute['CustomFieldName'] ) ) . '" name="edu-attr_' . esc_attr( $attribute['CustomFieldId'] . '_number' . ( '' !== $suffix ? '-' . $suffix : '' ) . ( $multiple ? '[]' : '' ) ) . '" value="' . esc_attr( ! empty( $data ) ? $data : '' ) . '" />';
	echo '</div></label>';
}
...
function render_date_field( $attribute, $multiple, $suffix, $data ) {
	...
	echo wp_kses_post( $attribute['CustomFieldName'] );
	echo '</div><div class="inputHolder">';
	echo '<input type="date" placeholder="' . esc_attr( wp_strip_all_tags( $attribute['CustomFieldName'] ) ) . '" name="edu-attr_' . esc_attr( $attribute['CustomFieldId'] . '_date' . ( '' !== $suffix ? '-' . $suffix : '' ) . ( $multiple ? '[]' : '' ) ) . '" value="' . esc_attr( $data ) . '" />';
	echo '</div></label>';
}
...
function render_textarea_field( $attribute, $multiple, $suffix, $data ) {
	...
	echo wp_kses_post( $attribute['CustomFieldName'] );
	echo '</div><div class="inputHolder">';
	echo '<textarea placeholder="' . esc_attr( wp_strip_all_tags( $attribute['CustomFieldName'] ) ) . '" name="edu-attr_' . esc_attr( $attribute['CustomFieldId'] . '_note' . ( '' !== $suffix ? '-' . $suffix : '' ) . ( $multiple ? '[]' : '' ) ) . '" rows="3" resizable="resizable">' . esc_textarea( ! empty( $data ) ? $data : '' ) . '</textarea>';
	echo '</div></label>';
}
...
function render_select_field( $attribute, $multiple, $suffix, $data ) {
	...
	echo wp_kses_post( $attribute['CustomFieldName'] );
	echo '</div><div class="inputHolder">';
	echo '<select name="edu-attr_' . esc_attr( $attribute['CustomFieldId'] . '_dropdown' . ( '' !== $suffix ? '-' . $suffix : '' ) . ( $multiple ? '[]' : '' ) ) . "\">\n";

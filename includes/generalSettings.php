...
<div class="eduadmin wrap">
	...
	<form method="post" action="options.php">
		...
		<div class="block">
			...
			<?php echo home_url(); ?>/<input style="width: 200px;" type="text" class="form-control folder" name="eduadmin-rewriteBaseUrl" id="eduadmin-rewriteBaseUrl" value="<?php echo esc_attr(get_option('eduadmin-rewriteBaseUrl')); ?>" placeholder="<?php echo __("URL", "eduadmin"); ?>" />/
<?php
	$pages = get_pages();
	$eduPages = array();
	foreach ($pages as $p)

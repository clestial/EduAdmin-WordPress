		...
		<div class="block">
			...
			<table>
				...
				foreach ( $phrases as $phrase => $translation ) {
					...
					<tr>
						...
						<td><input type="text" class="form-control" style="width: 300px;" onblur="update_phrase(event);"
			...
			<p class="submit">
				<input type="submit" name="submit" id="submit" class="button button-primary"
					   value="<?php echo esc_attr__( "Save settings", "eduadmin" ); ?>" />
				<input type="button"
					   onclick="var c = confirm('<?php _e( "Are you sure you want to reset the translation?", "eduadmin" ); ?>'); if (c) { var f = document.getElementById('resetForm').submit(); } else { return false; }"
					   class="button button-secondary"
					   value="<?php echo esc_attr__( "Reset translations", "eduadmin" ); ?>" />
			</p>
		</div>
